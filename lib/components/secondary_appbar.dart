    ...
    return Row(
      ...
      children: [
        GestureDetector(
            ...
            child: Container(
              padding: page == 'homepage'
                  ? EdgeInsets.symmetric(vertical: 10, horizontal: 10)
                  : EdgeInsets.all(0),
              decoration: page == 'homepage'
                  ? BoxDecoration(
        ...
        GestureDetector(
            ...
            child: Container(
              padding: page == 'petitions'
                  ? EdgeInsets.symmetric(vertical: 10, horizontal: 10)
                  : EdgeInsets.all(0),
              decoration: page == 'petitions'
                  ? BoxDecoration(
                      borderRadius: BorderRadius.circular(10),
                      gradient: LinearGradient(
                          begin: Alignment.centerLeft,
        ...
        GestureDetector(
            ...
            child: Container(
                padding: page == 'connect'
                    ? EdgeInsets.symmetric(vertical: 10, horizontal: 10)
                    : EdgeInsets.all(0),
                decoration: page == 'connect'
                    ? BoxDecoration(
                        borderRadius: BorderRadius.circular(10),
                        gradient: LinearGradient(
                            begin: Alignment.centerLeft,
