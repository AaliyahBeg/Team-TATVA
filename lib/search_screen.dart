...
import 'data/AQI/search_data.dart';
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  _search() async {
    ...
    final Response response =
        await get(Uri.parse(searchUrl + _controller.value.text.trim()));
            ...
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return ListTile(
                  ...
                  onTap: () async {
                    await Provider.of<AirQualityProvider>(context,
                            listen: false)
                        .dataFromSearch(data["data"][index]["station"]["url"]);
